        ...
        <div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
            ...
            <div class="d-flex flex-column flex-row-fluid position-relative p-7 overflow-hidden">
                ...
                <div class="position-absolute top-0 right-0 text-right mt-5 mb-15 mb-lg-0 flex-column-auto justify-content-center py-5 px-10">
                    ...
                    <a href="<?php echo base_url() ?>auth/register" class="font-weight-bold ml-2" id="kt_login_signup">Daftar!</a>
                </div>
                <!--end::Content header-->
                <!--begin::Content body-->
                <div class="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
                    ...
                    <div class="login-form login-signin">
                        ...
                        <div class="text-center mb-10 mb-lg-20">
                            ...
                            <p class="text-muted font-weight-bold">Masukan Email & Password Anda!</p>
                        </div>

                        <!--begin::Form-->
                        <form class="form" action="<?php echo base_url() ?>auth/login/submit" method="post">
                            <div class="form-group">
                                <input class="form-control form-control-solid h-auto py-5 px-6" type="email" placeholder="Email" name="email" id="email" autocomplete="on" required />
                            </div>
                            <div class="form-group">
                                <input class="form-control form-control-solid h-auto py-5 px-6" type="password" placeholder="Password" name="pass" id="pass" autocomplete="on" required />
                            </div>
                            <!--begin::Action-->
                ...
                <div class="d-flex d-lg-none flex-column-auto flex-column flex-sm-row justify-content-between align-items-center mt-5 p-5">
                    <div class="text-dark-50 font-weight-bold order-2 order-sm-1 my-2">© 2023 Firenze Higa & Agam Suteguh</div>
