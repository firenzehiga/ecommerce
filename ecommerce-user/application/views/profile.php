            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active px-7" id="kt_user_edit_tab_1" role="tabpanel">
                        <form id="form_input" role="form" method="post" enctype="multipart/form-data" accept-charset="utf-8" action="<?php echo base_url()?>main/profile/crud/">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12" align="center">
                                    <div class="image-input image-input-outline" id="kt_image_1">
                                        <div class="image-input-wrapper" style="background-image: url(<?php echo $cust_foto ?>)"></div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Isi Nama Lengkap" name="inp_nama" id="inp_nama" value="<?php echo $cust_nama; ?>" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <input type="email" class="form-control" placeholder="Isi Email" name="inp_email" id="inp_email" value="<?php echo $cust_email; ?>" required />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <input type="text" class="form-control" placeholder="Isi No. HP" name="inp_hp" id="inp_hp" value="<?php echo $cust_no_telp; ?>" required />
                                    </div>
                                </div>
                            </div>
                            <div class="separator separator-dashed my-2"></div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <input type="text" class="form-control" placeholder="Isi Alamat" name="inp_almt" id="inp_almt" value="<?php echo $cust_alamat; ?>" required />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <button type="submit" class="col-lg-12 btn btn-light-primary font-weight-bold" id="save_continue_button">Ubah</button>
                                </div>
                                <div class="col-lg-4"></div>
                            </div>
                        </form>
                    ...
                    <div class="tab-pane px-7" id="kt_user_edit_tab_3" role="tabpanel">
                        <form id="form_change" role="form" method="post" accept-charset="utf-8" action="<?php echo base_url() . $class . '/' . $method; ?>/changepass/">
                            ...
                            <input type="hidden" id="cust_id_change" name="cust_id_change" value="<?php echo $cust_id ?>">
                            <div class="card-body">
                                <div class="row">
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        $("#old_password").blur(function() {
            var rNum = "<?php echo $cust_id ?>";
            var old_password = $("#old_password").val();
            if (old_password != "") {
                var form_data = {};
                $.ajax({
                    url: "<?php echo base_url() ?>/Ajax/get_data/customer_old_password/?old_password=" + old_password + "&rNum=" + rNum,
                    type: 'POST',
                    data: form_data,
                    success: function(data) {
                        if ($.parseJSON(data)['data'] != null) {
                            if ($.parseJSON(data)['data'].cust_id > 0) {
