                        ...
                        <div class="card card-custom gutter-b col-lg-12 mb-5">
                            ...
                            <div class="card-header">
                                <div class="card-title">
                                    ...
                                    <span class="mb-5 font-weight-bold label label-inline label-light-warning mb-n7 mt-n7">Menunggu Verifikasi</span>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-n6">
                                            ...
                                            <tbody>
                                                ...
                                                $no = 0;
                                                $total = 0;
                                                $query_keranjang_dtl       = $this->db->query("SELECT * FROM v_keranjang_detail WHERE keranjang_status = 'Menunggu Verifikasi' AND keranjang_id =" . $keranjang_id . " " . "ORDER BY produk_nama");
