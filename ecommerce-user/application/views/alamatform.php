...
<body id="kt_body" class="header-fixed header-mobile-fixed">
                ...
                <div id="kt_header" class="header header-fixed ">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-wrap mr-2">
                            <div class="input-group input-group-md input-group-solid max-w-375px">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                ...
                <div class="d-flex flex-column">
                    <a href="./main/profile" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?php echo $this->session->userdata('cust_nama') ?></a>
                    <div class="navi mt-2">
            ...
            <div class="navi navi-spacer-x-0 p-0">
                        ...
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                                <span class="svg-icon svg-icon-md svg-icon-success">
                                    ...
                                    <i class="la la-wallet la-2x  text-success"></i>
                                    <!--end::Svg Icon-->
                                </span>
                            </div>
                        </div>
                ...
                <a href="custom/apps/user/profile-1/personal-information.html" class="navi-item">
                    <div class="navi-link">
                        ...
                        <div class="navi-text">
                            <div class="font-weight-bold">Menunggu Verifikasi</div>
                            <div class="text-muted">Menunggu Verifikasi Pembayaran
                                <span class="label label-light-danger label-inline font-weight-bold"> 1</span>
                            </div>
                        </div>
                    </div>
                </a>
                    ...
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                                <span class="svg-icon svg-icon-md svg-icon-success">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/General/Notification2.svg-->
                                    <i class="la la-truck-moving la-2x  text-danger"></i>
                                    <!--end::Svg Icon-->
                                </span>
                            </div>
                        </div>
                        <div class="navi-text">
                            <div class="font-weight-bold">Pesanan Dikirim</div>
    ...
    <div class="footer bg-white py-4 d-flex flex-lg-column print" id="kt_footer">
        <!--begin::Container-->
