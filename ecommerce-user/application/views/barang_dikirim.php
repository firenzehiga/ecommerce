                ...
                <div class="container">
                    <div class="flex-row-fluid ml-lg-8">
                        ...
                        foreach ($query_alamat->result() as $almt) {
                            ...
                            $no_resi        = $almt->keranjang_no_resi
                            ...
                            <div class="card card-custom gutter-b col-lg-12 mb-5">
                                ...
                                <div class="card-header">
                                    <div class="card-title">
                                        ...
                                        <span class="mb-5 font-weight-bold label label-inline label-light-success mb-n7 mt-n7">Pesanan Sudah Dikirim </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <h6 class="font-weight-bolder mb-n3 mt-n3">No. Resi : <?php echo $no_resi ?></h6>
                                ...
                                <div class="card-body mb-n6">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-n6">
                                                ...
                                                <tbody>
                                                    ...
                                                    $no = 0;
                                                    $total = 0;
                                                    $query_keranjang_dtl       = $this->db->query("SELECT * FROM v_keranjang_detail WHERE keranjang_status = 'Sudah Dikirim' AND keranjang_id =" . $keranjang_id . " " . "ORDER BY produk_nama");
                                    ...
                                    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                        ...
                                        <div class="card-toolbar mt-3 mb-3">
                                            ...
                                            <a href="<?= base_url() ?>main/barang_dikirim/submit_terima/?keranjang_id=<?= $keranjang_id; ?>" class="btn btn-info font-weight-bolder px-8">Barang Diterima</a>
